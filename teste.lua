...
function lib:init(ti, dosplash, visiblekey, deleteprevious)
    ...
    if dosplash then
        ...
        ug.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)
), ColorSequenceKeypoint.new(0.01, Color3.fromRGB(61, 61, 61)), ColorSequenceKeypoint.new(0.47, Color3.fromRGB(41, 41, 41)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))}
        ug.Rotation = 90
        ug.Parent = sicon
    ...
    workareacornerhider.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    notificon.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    notifbutton1.TextColor3 = Color3.fromRGB(0, 0, 0)
    ...
    notiftitle.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    notiftext.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    notif2.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    notif2icon.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    notif2title.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    notif2text.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    notif2button1.TextColor3 = Color3.fromRGB(0, 0, 0)
    ...
    function window:TempNotify(text1, text2, icon)
        ...
        tempnotif.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    function window:Divider(name)
        ...
        sidebardivider.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    function window:Section(name)
        ...
        workareamain.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
        ...
        function sec:TextField(name, placeholder, callback)
            ...
            textfield.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
            ...
            TextBox.BackgroundColor3 = Color3.new(0.019608, 0.050980, 0.941176)
